...
Дашборд разработан на основе датасета T Конференции, спикеры и речи. Данный дашборд позволяет получить информацию об опыте проведения предыдущих конференций в формате TED и сравнить данные по ним. Для удобства работы пользователь может отфильтровать данные по стране, названию конференции, тэгу и дате съемки выступления.
